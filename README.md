...
📖 **For detailed ESP32 setup, configuration, and troubleshooting, see the [Backend Documentation](src/README.md)**
...
- **📖 [Main README.md](README.md)** - Project overview, installation, and general information
- **📖 [Backend Documentation](src/README.md)** - API details, ESP32 integration, troubleshooting, and backend-specific information
- **📖 [Frontend Documentation](client/README.md)** - React components, UI features, styling, and frontend-specific information

Each README focuses on its specific domain while maintaining cross-references for comprehensive understanding.
